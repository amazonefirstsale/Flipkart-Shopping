    ...
    <>
      ...
      <div className="container-fluid ">
        <div ref={invoiceRef} style={{ backgroundColor: 'white', color: 'black' }}>
          ...
          <div className="p-1" style={{ backgroundColor: '#168e7aff', height: "2em" }} >
            <p>
          ...
          <div className="mb-3 row">
            <p className="fw-bold col-6">Term & Condition / Note Detailed bill  Done by broker on behalf of His client during a trading day</p>
            <img
