        ...
        <div ref={invoiceRef} style={{ backgroundColor: 'white', color: 'black' }}>
          ...
          <div className="row g-0">
            <div className="col-12 d-flex flex-column align-items-center mb-2">
              ...
              >
                <b>{(pavtiData[0]?.orgnization || "TRADE ORGANIZATION").toUpperCase()}</b>
          ...
          <div className="p-1" style={{ backgroundColor: '#866639ff', height: "2em" }} >
            <p>
          ...
          <div className="mb-3 row">
            <p className="fw-bold col-6">Term & Condition /  that records all transactions Done by broker on behalf of His client during a trading day</p>
            <img
